  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 prose-ks">
      ...
      <section className="space-y-4 text-muted-foreground">
        ...
        <p>Kami Street, société par actions simplifiée, SIREN 104 079 264, dont le siège social est situé 59 Avenue Joffre, 93800 Épinay-sur-Seine. Contact : contact@kamistreet.fr.</p>
